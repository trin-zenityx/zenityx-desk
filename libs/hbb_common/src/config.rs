...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("ZenityX Desk".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["194.233.69.204"];
pub const RS_PUB_KEY: &str = "FbQAPxazoUCGASq4M16Phxpm6csaoZr7xcR1JTahjyg=";
