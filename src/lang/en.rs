...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the ZenityX network..."),
        ...
        ("install_tip", "Due to UAC, ZenityX Desk can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install ZenityX Desk to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant ZenityX Desk \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant ZenityX Desk \"Screen Recording\" permissions."),
        ...
        ("zx_share_code", "Share my code with the instructor"),
        ("zx_code_copied", "Code copied — send it to your instructor"),
        ...
        ("doc_mac_permission", "https://desk.zenityx.com/help"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant ZenityX Desk \"Input Monitoring\" permissions."),
        ...
        ("About RustDesk", "About ZenityX Desk"),
