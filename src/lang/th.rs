...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ("Status", "สถานะ"),
        ("Your Desktop", "เครื่องของคุณ"),
        ("desk_tip", "ส่ง ID และรหัสผ่านนี้ให้ผู้สอน เพื่อให้เชื่อมต่อเข้ามาช่วยสอนได้"),
        ("Password", "รหัสผ่าน"),
        ("Ready", "พร้อม"),
        ("Established", "เชื่อมต่อแล้ว"),
        ("connecting_status", "กำลังเชื่อมต่อไปยังเซิร์ฟเวอร์ ZenityX..."),
        ...
        ("Control Remote Desktop", "เชื่อมต่อไปยังอีกเครื่อง"),
        ...
        ("files", "ไฟล์"),
        ("Waiting", "กำลังรอ"),
        ("zx_cm_waiting", "กำลังรอผู้สอนเชื่อมต่อ…"),
        ("zx_share_code", "ส่งรหัสให้ผู้สอน"),
        ("zx_code_copied", "คัดลอกรหัสแล้ว ส่งให้ผู้สอนได้เลย"),
        ("Finished", "เสร็จแล้ว"),
        ("Speed", "ความเร็ว"),
        ...
        ("install_tip", "เนื่องด้วยข้อจำกัดของ UAC ทำให้ ZenityX Desk อาจทำงานไม่สมบูรณ์ในบางกรณี กดปุ่มด้านล่างเพื่อติดตั้ง ZenityX Desk ลงระบบ"),
        ("Click to upgrade", "คลิกเพื่ออัปเกรด"),
        ("Configure", "ปรับแต่งค่า"),
        ("config_acc", "เพื่อให้ผู้สอนควบคุมเครื่องของคุณได้ ต้องอนุญาตสิทธิ์ \"การช่วยการเข้าถึง (Accessibility)\" ให้ ZenityX Desk"),
        ("config_screen", "เพื่อให้ผู้สอนเห็นหน้าจอของคุณ ต้องอนุญาตสิทธิ์ \"การบันทึกภาพหน้าจอ (Screen Recording)\" ให้ ZenityX Desk"),
        ...
        ("Enter Remote ID", "กรอก ID เครื่องปลายทาง"),
        ...
        ("config_input", "เพื่อให้ผู้สอนใช้คีย์บอร์ดควบคุมได้ ต้องอนุญาตสิทธิ์ \"การตรวจสอบอินพุต (Input Monitoring)\" ให้ ZenityX Desk"),
        ...
        ("empty_recent_tip", "ยังไม่มีการเชื่อมต่อล่าสุด"),
        ("empty_favorite_tip", "ยังไม่มีรายการโปรด"),
        ("empty_lan_tip", "ยังไม่พบอุปกรณ์ในเครือข่าย"),
        ("empty_address_book_tip", "ยังไม่มีรายชื่อที่บันทึกไว้"),
        ...
        ("About RustDesk", "เกี่ยวกับ ZenityX Desk"),
